    ...
    <Box sx={style.mainCon}>
      ...
      <Box sx={style.PaperCon}>
        <Paper sx = {style.paper}>
          ...
          <Typography sx = {style.price}><Typography sx = {style.dollorSign}>$</Typography>{perimeter ? "19.99": "199.99"}</Typography>
        ...
        <Paper sx = {style.paperMid}>
          <Typography sx = {style.paperTitle} style = {{color : "white"}}>Professional</Typography>
          <Typography sx = {style.price} style = {{color : "white"}}><Typography sx = {style.dollorSign} style = {{color : "white"}}>$</Typography>{perimeter ? "24.99":"249.99"}</Typography>
          <Box sx={style.divider}></Box>
          <Typography sx = {style.info} style = {{color : "white"}}>1 TB Storage</Typography>
          <Box sx={style.divider}></Box>
          <Typography sx = {style.info} style = {{color : "white"}}>5 Users Allowed</Typography>
          <Box sx={style.divider}></Box>
          <Typography sx = {style.info} style = {{color : "white"}}>Send up to 10 GB</Typography>
          <Box sx={style.divider}></Box>
          <Button sx = {style.ButtonMid}>Learn more</Button>
        </Paper>
        <Paper sx = {style.paper}>
        <Typography sx = {style.paperTitle}>Basic</Typography>
          <Typography sx = {style.price}><Typography sx = {style.dollorSign}>$</Typography>{perimeter ? "39.99":"399.99"}</Typography>
          <Box sx={style.divider}></Box>
